...
#
PRODUCT_NAME := cyanogen_m1001gb
PRODUCT_BRAND := telechips
PRODUCT_DEVICE := tcc8902gb
PRODUCT_MODEL := Haipad M1001 GB
PRODUCT_MANUFACTURER := Haina
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=m1001gb BUILD_ID=GRK39F BUILD_DISPLAY_ID=GWK74 BUILD_FINGERPRINT=google/soju/crespo:2.3.6/GRK39F/189904:user/release-keys PRIVATE_BUILD_DESC="soju-user 2.3.6 GRK39F 189904 release-keys" BUILD_NUMBER=189904
